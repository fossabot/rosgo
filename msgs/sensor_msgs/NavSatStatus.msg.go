...
// source: /opt/ros/jade/share/ros/../sensor_msgs/msg//NavSatStatus.msg
// DO NOT EDIT!
package sensor_msgs
...
func (m *NavSatStatus) Serialize(buf *bytes.Buffer) (err error) {
	// STATUSNOFIX
	binary.Write(buf, binary.LittleEndian, m.STATUSNOFIX)
...
func (m *String) Deserialize(buf *bytes.Reader) (err error) {
	// STATUSNOFIX
	if err = binary.Read(buf, binary.LittleEndian, &m.STATUSNOFIX); err != nil {
		return err
	}
